...
録音した番組を聴いていて、あとで聞き返したいところが出てきたら、再生画面いちばん下の「印を置く」を押してください。**その場で印が残ります。再生は止まりません。** あとから一覧でメモを添えることもできます。
...
**らじぽけは Google Play で公開しています。** フリープランのままでもお使いいただけますし、有料プランへのご加入はアプリの中（設定 → アカウントとプラン）からお手続きいただけます。解約も Google Play 側のお手続きで、いつでも止められます。

**お支払いいただく金額は、Google Play ストアに表示されるものが正です。** 上の表は日本でお使いいただく場合の目安としてお読みください。

## クローズドテスト

公開前のクローズドテストにご協力いただき、ありがとうございました。おかげさまで所定の期間と人数を満たすことができ、**テスターの募集は終了しています。**
