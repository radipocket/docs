...
**クローズドテストにご参加いただいている間は、すべての機能を無料でお使いいただけます。** 有料プランの提供開始時期は未定です。

## クローズドテスト

Google Play でのクローズドテストは所定の期間と人数を満たし、**テスターの募集は終了しています。** ご協力いただいた皆さまに深く感謝いたします。

**テスト期間中は、プレミアムプランの機能をすべて無料でお使いいただけます**（期間が終わるとフリープランに戻ります）。テスト期間中のプランの扱いは [クローズドテストのご案内](test.html) をご覧ください。
